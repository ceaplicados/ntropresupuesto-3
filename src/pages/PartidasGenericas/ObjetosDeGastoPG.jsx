...
const ObjetosDeGastoPG = ({cgActual}) => {
        ...
        if(cgActual.Clave){
            const getHistoricoCG = async (claveCG) => {
                ...
                urlVariables.get('v') ?
                    ...
                    : null; 
                const response = await axios(estadoActual.Codigo+'/ObjetoDeGasto/'+claveCG+'?v='+idsVersiones.join(','));
    ...
    useEffect(() => {
        ...
        const labelsActual=conceptosGeneralesDeflactado.map((concepto) => {
            return concepto.objetoDeGasto.Clave+' - '+concepto.objetoDeGasto.Nombre;
        });
        let tablaActual=[];
        const dataChartActual=conceptosGeneralesDeflactado.map((concepto) => {
            let Monto = concepto.presupuestos.filter((presupuesto) => {
                if(presupuesto.Id==versionActual.Id){
                    tablaActual.push({
                        concepto: concepto.objetoDeGasto,
        ...
        const configChartHistorico = {
            ...
            datasets: conceptosGeneralesDeflactado.map((concepto) => {
                return {
                    label: concepto.objetoDeGasto.Clave+' - '+concepto.objetoDeGasto.Nombre,
        ...
        const renglonesDiferencias = conceptosGeneralesDeflactado.map((concepto) => {
            ...
            return {
                objetoDeGasto: concepto.objetoDeGasto,
                Color: concepto.Color,
        ...
        const dataChartDiferencias={
            ...
            datasets: renglonesDiferencias.map((renglon) => {
                return {
                    label: renglon.objetoDeGasto.Clave+' - '+renglon.objetoDeGasto.Nombre,
                ...
                <table className='table table-striped table-bordered table-responsive' id='tablaCapitulosGasto'>
                            ...
                            return (
                                <tr key={renglon.Id}>
                                    <td>
                                        ...
                                        {renglon.objetoDeGasto.Clave} - {renglon.objetoDeGasto.Nombre} 
                                    </td>
                                    { versiones.filter((version) => version.Actual).map((version) => {
                    ...
                    <tfoot>
                        <tr>
                            ...
                            { versiones.filter((version) => version.Actual===true).map((version) => {
                                    return totalesPresupuestos
                                        .filter((presupuesto) => presupuesto.Version.Id===version.Id)
                                        .map((presupuesto) => {
                                            return (
                ...
                <table className='table table-striped table-bordered table-responsive' id='tablaCapitulosGasto'>
                    ...
                    <tbody>
                        {renglonesTablaDiferencias.map((renglon) => {
                            return (
                                <tr key={renglon.objetoDeGasto.Id}>
                                    <td>
                                        <span className='leyenda' style={{backgroundColor: renglon.Color}}></span>
                                        {renglon.objetoDeGasto.Clave} - {renglon.objetoDeGasto.Nombre} 
                                    </td>
...
export default ObjetosDeGastoPG